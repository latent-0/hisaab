...
export default function PaytmV2() {
  // Every control on this shell leads into the live Hisaab product.
  // Full navigation (not router.push) so the /v2/open-hisaab route handler runs
  // its sign-in + redirect server-side.
  const demo = () => {
    window.location.href = "/v2/open-hisaab";
  };
